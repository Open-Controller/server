...
// .proto file is parsed by protoc 3.16.0
// @generated
...
impl Lambda {
    ...
    pub fn get_int32(&self) -> i32 {
        match self.inner {
            ::std::option::Option::Some(lambda::Inner::int32(v)) => v,
            _ => 0,
        }
    }
    ...
    pub fn has_int32(&self) -> bool {
        match self.inner {
            ::std::option::Option::Some(lambda::Inner::int32(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_int32(&mut self, v: i32) {
        self.inner = ::std::option::Option::Some(lambda::Inner::int32(v))
    }
    ...
    pub fn get_int64(&self) -> i64 {
        match self.inner {
            ::std::option::Option::Some(lambda::Inner::int64(v)) => v,
            _ => 0,
        }
    }
    ...
    pub fn has_int64(&self) -> bool {
        match self.inner {
            ::std::option::Option::Some(lambda::Inner::int64(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_int64(&mut self, v: i64) {
        self.inner = ::std::option::Option::Some(lambda::Inner::int64(v))
    }

    // optional float float = 18;

    pub fn get_float(&self) -> f32 {
        match self.inner {
            ::std::option::Option::Some(lambda::Inner::float(v)) => v,
            _ => 0.,
        }
    }
    ...
    pub fn has_float(&self) -> bool {
        match self.inner {
            ::std::option::Option::Some(lambda::Inner::float(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_float(&mut self, v: f32) {
        self.inner = ::std::option::Option::Some(lambda::Inner::float(v))
    }

    // optional .model.GetIndexFunc get_index = 19;

    pub fn get_get_index(&self) -> &GetIndexFunc {
        match self.inner {
            ::std::option::Option::Some(lambda::Inner::get_index(ref v)) => v,
            _ => <GetIndexFunc as ::protobuf::Message>::default_instance(),
        }
    }

    pub fn clear_get_index(&mut self) {
        self.inner = ::std::option::Option::None;
    }

    pub fn has_get_index(&self) -> bool {
        match self.inner {
            ::std::option::Option::Some(lambda::Inner::get_index(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_get_index(&mut self, v: GetIndexFunc) {
        self.inner = ::std::option::Option::Some(lambda::Inner::get_index(v))
    }

    // Mutable pointer to the field.
    pub fn mut_get_index(&mut self) -> &mut GetIndexFunc {
        if let ::std::option::Option::Some(lambda::Inner::get_index(_)) = self.inner {
        } else {
            self.inner = ::std::option::Option::Some(lambda::Inner::get_index(GetIndexFunc::new()));
        }
        match self.inner {
            ::std::option::Option::Some(lambda::Inner::get_index(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_get_index(&mut self) -> GetIndexFunc {
        if self.has_get_index() {
            match self.inner.take() {
                ::std::option::Option::Some(lambda::Inner::get_index(v)) => v,
                _ => panic!(),
            }
        } else {
            GetIndexFunc::new()
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_oneof_message_has_get_mut_set_accessor::<_, GetIndexFunc>(
            "get_index",
            Lambda::has_get_index,
            Lambda::get_get_index,
            Lambda::mut_get_index,
            Lambda::set_get_index,
        ));
...
impl ::protobuf::Message for Lambda {
    fn is_initialized(&self) -> bool {
        ...
        if let Some(lambda::Inner::get_index(ref v)) = self.inner {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                16 => {
                    ...
                    self.inner = ::std::option::Option::Some(lambda::Inner::int32(is.read_int32()?));
                },
                17 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.inner = ::std::option::Option::Some(lambda::Inner::int64(is.read_int64()?));
                },
                18 => {
                    if wire_type != ::protobuf::wire_format::WireTypeFixed32 {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.inner = ::std::option::Option::Some(lambda::Inner::float(is.read_float()?));
                },
                19 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.inner = ::std::option::Option::Some(lambda::Inner::get_index(is.read_message()?));
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.inner {
            match v {
                ...
                &lambda::Inner::int32(v) => {
                    my_size += ::protobuf::rt::value_size(16, v, ::protobuf::wire_format::WireTypeVarint);
                },
                &lambda::Inner::int64(v) => {
                    my_size += ::protobuf::rt::value_size(17, v, ::protobuf::wire_format::WireTypeVarint);
                },
                &lambda::Inner::float(v) => {
                    my_size += 6;
                },
                &lambda::Inner::get_index(ref v) => {
                    let len = v.compute_size();
...
impl<'a> ::std::default::Default for &'a GetIndexFunc {
    fn default() -> &'a GetIndexFunc {
        <GetIndexFunc as ::protobuf::Message>::default_instance()
    }
}

impl GetIndexFunc {
    pub fn new() -> GetIndexFunc {
        ::std::default::Default::default()
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_get_copy_simpler_accessor::<_, _>(
            "index",
            |m: &GetIndexFunc| { &m.index },
            |m: &mut GetIndexFunc| { &mut m.index },
            GetIndexFunc::get_index,
        ));
...
impl ::protobuf::Message for GetIndexFunc {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn default_instance() -> &'static GetIndexFunc {
        static instance: GetIndexFunc = GetIndexFunc {
...
impl ::protobuf::Clear for GetIndexFunc {
    fn clear(&mut self) {
        self.index = ::std::option::Option::None;
        self.unknown_fields.clear();
    }
...
impl ::std::fmt::Debug for GetIndexFunc {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for GetIndexFunc {
    type RuntimeType = ::protobuf::reflect::runtime_types::RuntimeTypeMessage<Self>;
}
...
pub fn file_descriptor() -> ::protobuf::reflect::FileDescriptor {
    ...
    let file_descriptor = file_descriptor_lazy.get(|| {
        ...
        messages.push(GetIndexFunc::generated_message_descriptor_data());
